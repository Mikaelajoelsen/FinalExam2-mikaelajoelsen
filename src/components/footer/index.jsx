        ...
        <div className="bg-stone-50 p-10">
          ...
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex mt-6 sm:justify-center sm:mt-6">
                <a
                  href="#"
                ...
                <a href="#" className="text-black hover:text-blue-600 ms-5">
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="#"
                  className="text-black hover:text-orange-400  dark:hover:text-white ms-5"
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
              ...
              <div>
                ...
                <ul className="text-black dark:text-gray-400 font-thin">
                  <li>
                    <a
                      href="#"
                      className="hover:text-gradient-to-br from-pink-300 via-pink-50 to-violet-100 "
                    >
                      Github
                    </a>
                  </li>
